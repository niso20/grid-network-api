...
def add_column(table_name: str, column: Column[Any], integer, *, schema: Optional[str] = None, default=20,
               postgresql_after='existing_column_name') -> None:
